...
public class Wordle {
        ...
        try (PrintWriter log = new PrintWriter(new FileWriter("wordle.log", true))) {
            ...
            while (true) {
                ...
                try {
                    ...
                    playGame(dictionary, scanner, logger);
                } catch (Exception e) {
                    logger.logError(e);
                }
            }
    ...
    private static WordleDictionary loadDictionary() throws IOException {
    ...
    private static void playGame(WordleDictionary dictionary, Scanner scanner, GameLogger logger) {
        ...
        while (!game.isFinished()) {
            ...
            if (guess.isEmpty()) {
                ...
                } catch (ZeroHintsException | WordLengthException e) {
